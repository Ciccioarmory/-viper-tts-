...
This is a standalone script and depend on [xsoundTts](https://github.com/Xogy/xsoundTts).
You can download the xsoundTts repository but you will need to uncomment the **TextToSpeech**. Or you can use the one here.
